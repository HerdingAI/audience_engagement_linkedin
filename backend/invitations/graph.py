...
class LinkedInGraph:
    ...
    def _build_graph(self):
        ...
        def comment_crafter(state):
            return self.nodes.comment_crafter_node(state)
        ...
        workflow.add_node("comment_crafter", comment_crafter)
        ...
        workflow.add_edge("research_synthesis", "comment_crafter")
        workflow.add_edge("comment_crafter", "final_quality_check")
